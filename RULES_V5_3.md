# NEON STACK — Règles officielles V5.3 harmonisées


## Nouveautés V5.3
Cette version conserve la structure V5.2 et intègre les clarifications issues des tests :
- le joueur actif choisit l’ordre de mise à jour de ses fonctions ;
- les Commandes, comme les Interrupts, libèrent leur mémoire après résolution ;
- les Hardware occupent leur mémoire tant qu’ils restent en jeu ;
- les cadres parasites ajoutés avant [0] ne bloquent pas la descente ;
- la mémoire libre ne descend jamais sous 0 ;
- Overclocking et Bombe à Retours sont rééquilibrées.
...
## 20. Commandes, Interrupts et mémoire
...
## 25. Cartes rééquilibrées en V5.3
